...
public class Movement : MonoBehaviour
{
    ...
    public IEnumerator MoveboxCutter(GameObject boxCutter, Vector3 startingPosition, Vector3 targetPosition, double duration)
    {
        float elapsedTime = 0;
        ...
        while (elapsedTime < duration)
        {
            boxCutter.transform.position = Vector3.Lerp(startingPosition, targetPosition, (float)(elapsedTime / duration));
            elapsedTime += Time.deltaTime;
            yield return null;
        }
    }
